...
def format_help_message() -> str:
    ...
    return (
        ...
        "• <code>/ass</code> - 打开 ASS 菜单（子集化字体 / 内封字幕）\n"
        "• <code>/emby_tasks</code> - 打开 Emby 计划任务面板\n"
        "• <code>/strm_status</code> - 查看STRM监控状态\n"
        "• <code>/strm_scan</code> - 手动触发STRM重扫\n"
        "• <code>/strm_restart</code> - 重启STRM watcher\n"
        "• <code>/rm_strm</code> - 预览STRM空目录并按钮确认删除\n"
        ...
        "• 📤 一键添加到SA\n"
        "• 💰 积分资源自动解锁\n"
        "• 🧩 Emby计划任务查看 / 启动 / 停止 / 结果通知\n"
        "• 🧹 STRM空目录手动清理\n"
        "• 🔤 ASS 字幕子集化字体内封 / MKV 字幕内封\n\n"
        "📝 <b>使用示例：</b>\n"
        "• <code>/hdt 狂飙</code>\n"
        "• <code>/hdm 流浪地球</code>\n"
        "• <code>/ass</code>\n"
        "• <code>/emby_tasks</code>\n"
        "• <code>/rm_strm</code>\n"
        "• 直接发送资源链接\n\n"
        "━━━━━━━━━━━━━━━━━━━━━━"
    )
